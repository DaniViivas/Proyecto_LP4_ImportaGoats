...
public function crear(){    
 ...
 public function actualizar() {
  ...
  $query = "CALL sp_actualizar_persona(:p_id_persona_pk, :p_nombre, :p_direccion, :p_correo_electronico, :p_telefono, :p_fecha_afiliacion, :p_DNI, :p_fecha_nacimiento, :p_usuario, :p_contraseña, :p_tipo_persona_fk);
  $stmt = $this->conn->prepare($query);
